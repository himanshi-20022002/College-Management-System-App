...
class ListOfClassesAdapter(options: FirestoreRecyclerOptions<SubjectsDetails>):
    FirestoreRecyclerAdapter<SubjectsDetails, ListOfClassesAdapter.SubjectViewHolder>(options) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ListOfClassesAdapter.SubjectViewHolder {
    ...
    override fun onBindViewHolder(
        holder: ListOfClassesAdapter.SubjectViewHolder,
        position: Int,
        ...
        holder.takeAttendance.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                val intent = Intent(v!!.context, ListOfStudents::class.java)
